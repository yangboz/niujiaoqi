...
+(CCScene *) scene
{
    ...
    // from the ccbi-file. 
    CCScene* scene02 = [CCBReader sceneWithNodeGraphFromFile:@"HelloCocosBuilder.ccbi" owner:self]; 
...
//        CCNode *sleeplessNodeGraph = [CCBReader nodeGraphFromFile:@"Sleepless.ccbi"];
//		[self addChild: sleeplessNodeGraph];
